...
const CounterButton: React.FC<CounterButtonProps> = ({
  ...
  productName,
    ...
    <div className={`${className} ${styles.buttonContainer}`}>
      <button className={styles.changeButton} onClick={handleSubtract} aria-label={`decrease shopping cart quantity of ${productName}`}>
      ...
      <button className={styles.changeButton} onClick={handleAdd} aria-label={`increase shopping cart quantity of ${productName}`}>
