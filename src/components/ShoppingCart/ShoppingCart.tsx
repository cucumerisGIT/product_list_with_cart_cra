...
const ShoppingCart: React.FC = () => {
  ...
  const { cartContent, totalPrice, totalItemCount, setOrderConfirmationVisible } = context;
	...
	return (
		<section className={styles.shoppingCart}>
			<h3 className={styles.title}>Your Cart ({totalItemCount})</h3>
			{totalItemCount === 0 ?
				<>
					<svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" fill="none" viewBox="0 0 128 128">
						...
						<path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth=".974" d="m81.076 28.966 34.187-4.16" />
				...
				<div className={styles.wrapper}>
					...
					<div className={styles.carbonHint}>
						<svg className={styles.carbonIcon} xmlns="http://www.w3.org/2000/svg" width="21" height="20" fill="none" viewBox="0 0 21 20">
						...
						<p>This is a <span className={styles.carbonNeutral}>carbon-neutral</span> delivery</p>
					</div>
					<button className={styles.confirmOrder} onClick={handleOrderConfirmation}>Confirm Order</button>
				</div>
			}
		</section>
	);
